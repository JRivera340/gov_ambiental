...
// Vista de detalle de ADMIN — portada de /admin/actividad/:id del hub
// (SOLO LECTURA), comparada 2026-07-29 contra `components/ActivityDetail.tsx`
// del hub. A diferencia del hub (que auto-renderiza respuestas de encuesta
// genéricas vía __fieldMeta), este repo tiene los 26 campos del formulario
// fijo como columnas propias — se renderizan aquí con su label real usando
// la misma config `SECCIONES_PUNTO_ACUMULACION` que usa el formulario de
// creación, en vez de reinventar una lista de campos aparte.
//
// Botón "Ver en Google Maps": no existe en el hub, es una mejora deliberada
// (ver ESTADO-EXTRACCION.md, Divergencias) — se mantiene también acá.
  ...
  if (error || !activity) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 text-center p-6">
        ...
        <button onClick={() => navigate('/admin')} className="btn-primary">Volver al panel</button>
      </div>
    );
  }
