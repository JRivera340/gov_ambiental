...
// CamposGenerales/CampoInput viven en components/CamposGenerales.tsx —
// compartidos con EditActivity.tsx, que los reusa para precargar el formulario
// con las respuestas ya guardadas (ver hallazgo del recorrido visual).
