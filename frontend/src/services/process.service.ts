...
// Ruta correcta de este backend es /procesos (ProcesosController), no
// /sorver/processes — ese prefijo era del hub. Sin uso real en la UI
// todavía, pero corregido para que funcione el día que se conecte.
