...
// El hub no usa cva para Card (clases fijas) — acá si, por decision explicita
// de unificar el patron en todas las primitivas de este repo.
  ...
  "rounded-xl border bg-white transition-shadow",
  {
    variants: {
      variant: {
        ...
        flat: "border-neutral-100 shadow-none",
      },
    },
    defaultVariants: {
      variant: "default",
